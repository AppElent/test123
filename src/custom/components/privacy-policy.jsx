...
// https://www.privacypolicygenerator.info/download.php?lang=en&token=EZ2nUjN4TIlGDftxW9YTLqsB2nxa8kMF#

export const PrivacyPolicy = ({ title, url }) => {
  return (
    <>
      <h1>Privacy Policy for {url}</h1>

      <p>
        At {title}, accessible from {url}, one of our main priorities is the privacy of our
      ...
      <p>
        ...
        Beacons that are used in their respective advertisements and links that appear on {title},
