...
export const TermsAndConditions = (props) => {
  ...
  return (
    <>
      ...
      <p>
        These terms and conditions outline the rules and regulations for the use of {url}
        &quot;s Website, located at {url}.
      </p>

      <p>
        By accessing this website we assume you accept these terms and conditions. Do not continue
        to use {title} if you do not agree to take all of the terms and conditions stated on this
        page.
      </p>
      ...
      <p>
        We employ the use of cookies. By accessing {title}, you agreed to use cookies in agreement
        with the
      ...
      <p>
        Unless otherwise stated, {url} and/or its licensors own the intellectual property rights for
        all material on
        {title}. All intellectual property rights are reserved. You may access this from {title} for
      ...
      <ul>
        ...
        <li>Redistribute content from {title}</li>
      </ul>
      ...
      <p>
        ...
        {url} does not filter, edit, publish or review Comments prior to their presence on the
        website. Comments do not reflect the views and opinions of {url},its agents and/or
        affiliates. Comments reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, {url} shall not be liable for the
      ...
      <p>
        {url} reserves the right to monitor all Comments and to remove any Comments which can be
      ...
      <p>
        You hereby grant {url} a non-exclusive license to use, reproduce, edit and authorize others
      ...
      <p>
        ...
        {url}; and (d) the link is in the context of general resource information.
      </p>
      ...
      <p>
        ...
        linking to our website, you must inform us by sending an e-mail to {url}. Please include
      ...
      <p>
        No use of {url}&quot;s logo or other artwork will be allowed for linking absent a trademark
        license agreement.
      </p>
